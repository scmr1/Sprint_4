...
public class OrderMakerTest {
    ...
    public OrderMakerTest(String name, String surname, String address, String metro, String phoneNumber, String date, String comment) {
        this.name = name;
    ...
    public static Object[][] getData() {
        return new Object[][] {
                { "Имя", "Фамилия", "Адрес", "Мякинино", "79999999999", "04.12.2022", "комментарий"},
                { "Антон", "Антонов", "Антоновская", "Планерная", "79999999997", "10.12.2022", "антон"},
        };
    }
